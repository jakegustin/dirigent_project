...
- Copy traces from this folder on local machine to `node0` using `scp artifact_evaluation/azure_500/modified/azure_500/* user@node0:~/invitro/data/traces/azure_500/`.
